<template>
    ...
    <div class="apresentacao">
      <img src="../assets/images/logo.svg" alt="LogoTipo" class="logo">
    ...
    <img src="../assets/images/foto-banner.png" alt="foto de uma mulher cozinhando com uma bacia e um fouet em suas mãos" class="foto-banner">
  </header>
</template>
